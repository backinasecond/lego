 ...
 */
public class CustomArbitrator implements Runnable {
	 ...
	 * behavior of highest priority. If higher than the active behavior, it
	 ...
	 *            Behavior is active.
	 */
	public CustomArbitrator(Behavior[] behaviorList, boolean returnWhenInactive) {
	 ...
	 *            An array of Behavior objects.
	 */
	public CustomArbitrator(Behavior[] behaviorList) {
	 ...
	 * on the most recently acrive behavior.
	 */
